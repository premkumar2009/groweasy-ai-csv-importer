...
export const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn('rounded-2xl border border-slate-200 bg-white/85 text-slate-950 shadow-soft backdrop-blur dark:border-slate-800 dark:bg-slate-950/70 dark:text-slate-50', className)} {...props} />
));
